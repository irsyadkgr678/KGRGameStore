...
export const GameDetail: React.FC = () => {
  ...
  if (!game) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-400 mb-2">Game Not Found</h2>
          <p className="text-gray-500 mb-4">The game you're looking for doesn't exist.</p>
          <Link
            to="/"
            className="inline-flex items-center px-4 py-2 bg-purple-600 hover:bg-purple-700 rounded-lg font-medium text-white transition-colors duration-200"
          >
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-6">
        <Link
          to="/"
          className="inline-flex items-center px-4 py-2 bg-gray-800/50 hover:bg-gray-700/50 rounded-lg font-medium text-gray-300 hover:text-white transition-all duration-200 border border-gray-700/50"
        >
          <ArrowLeft className="w-4 h-4 mr-2" />
          Back to Games
        </Link>
        ...
        <div className="space-y-4">
          ...
          <div className="relative bg-gray-800/50 rounded-xl overflow-hidden border border-gray-700/50 aspect-video">
            ...
            {game.trailer_url && !showTrailer && (
              ...
              >
                <div className="bg-purple-600 hover:bg-purple-700 rounded-full p-4 group-hover:scale-110 transition-transform duration-200">
            ...
            {showTrailer && (
              <button
                ...
                className="absolute top-4 right-4 bg-gray-800/80 hover:bg-gray-700/80 rounded-lg p-2 text-white transition-colors duration-200"
              >
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50">
            ...
            <div className="flex flex-wrap gap-2">
              {platforms.map((platform) => (
                <span key={platform} className="inline-flex items-center px-3 py-2 rounded-lg text-sm font-medium bg-blue-600/20 text-blue-300 border border-blue-500/30">
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50">
            ...
            <button
              ...
              className="w-full flex items-center justify-center space-x-2 px-6 py-4 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold rounded-lg transition-all duration-200 hover:shadow-lg hover:shadow-purple-500/25 text-lg"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50">
            <h3 className="text-2xl font-semibold text-white mb-4">About This Game</h3>
          ...
          {hasPCPlatform && game.minimum_specs && (
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50">
              ...
              <div className="bg-gray-700/30 rounded-lg p-4">
                <h4 className="text-lg font-medium text-purple-300 mb-4">Minimum Requirements</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {game.minimum_specs.os && (
                    <div className="flex items-start space-x-3">
                      <Settings className="w-5 h-5 text-gray-400 mt-0.5 flex-shrink-0" />
                      <div>
                        <div className="text-sm font-medium text-gray-300">Operating System</div>
                        <div className="text-white">{game.minimum_specs.os}</div>
                      </div>
                    </div>
                  )}
                  {game.minimum_specs.processor && (
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-white">{game.minimum_specs.processor}</div>
                      </div>
                    </div>
                  )}
                  {game.minimum_specs.memory && (
                    <div className="flex items-start space-x-3">
                      <MemoryStick className="w-5 h-5 text-gray-400 mt-0.5 flex-shrink-0" />
                      <div>
                        <div className="text-sm font-medium text-gray-300">Memory</div>
                        <div className="text-white">{game.minimum_specs.memory}</div>
                      </div>
                    </div>
                  )}
                  {game.minimum_specs.graphics && (
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-white">{game.minimum_specs.graphics}</div>
                      </div>
                    </div>
                  )}
                  {game.minimum_specs.directx && (
                    <div className="flex items-start space-x-3">
                      <Settings className="w-5 h-5 text-gray-400 mt-0.5 flex-shrink-0" />
                      <div>
                        <div className="text-sm font-medium text-gray-300">DirectX</div>
                        <div className="text-white">{game.minimum_specs.directx}</div>
                      </div>
                    </div>
                  )}
                  {game.minimum_specs.storage && (
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-white">{game.minimum_specs.storage}</div>
                      </div>
                    </div>
                  )}
                </div>
