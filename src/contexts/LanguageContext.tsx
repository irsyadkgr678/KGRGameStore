...
const translations = {
  id: {
    ...
    'auth.checkEmailConfirmation': 'Silakan periksa email Anda dan klik tautan konfirmasi untuk mengaktifkan akun.',
    'auth.emailConfirmed': 'Email berhasil dikonfirmasi! Anda sekarang dapat masuk.',
    'auth.emailNotConfirmed': 'Email belum dikonfirmasi. Silakan periksa email Anda dan klik tautan konfirmasi.',
    'auth.forgotPassword': 'Lupa kata sandi?',
    'auth.resetPassword': 'Reset Kata Sandi',
    'auth.resetPasswordDescription': 'Masukkan email Anda untuk menerima tautan reset kata sandi',
    'auth.enterEmailForReset': 'Masukkan email untuk reset kata sandi',
    'auth.sendResetEmail': 'Kirim Email Reset',
    'auth.resetPasswordEmailSent': 'Email reset kata sandi telah dikirim. Periksa kotak masuk Anda.',
    'auth.backToLogin': 'Kembali ke Login',
    'auth.setNewPassword': 'Atur Kata Sandi Baru',
    'auth.enterNewPassword': 'Masukkan kata sandi baru Anda',
    ...
    'auth.passwordResetSuccess': 'Kata sandi berhasil diperbarui! Anda akan diarahkan ke halaman login.',
    'auth.passwordsDoNotMatch': 'Kata sandi tidak cocok',
    'auth.passwordTooShort': 'Kata sandi harus minimal 6 karakter',
    'auth.invalidResetLink': 'Tautan reset tidak valid atau sudah kedaluwarsa',
  ...
  en: {
    ...
    'auth.checkEmailConfirmation': 'Please check your email and click the confirmation link to activate your account.',
    'auth.emailConfirmed': 'Email confirmed successfully! You can now sign in.',
    'auth.emailNotConfirmed': 'Email not confirmed. Please check your email and click the confirmation link.',
    'auth.forgotPassword': 'Forgot password?',
    'auth.resetPassword': 'Reset Password',
    'auth.resetPasswordDescription': 'Enter your email to receive a password reset link',
    'auth.enterEmailForReset': 'Enter email for password reset',
    'auth.sendResetEmail': 'Send Reset Email',
    'auth.resetPasswordEmailSent': 'Password reset email has been sent. Check your inbox.',
    ...
    'auth.passwordResetSuccess': 'Password updated successfully! You will be redirected to login.',
